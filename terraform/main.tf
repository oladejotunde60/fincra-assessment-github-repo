...
resource "aws_security_group" "eks_pods" {
  name_prefix = "${var.cluster_name}-pods-sg"
...
# Security Group Rule to allow ALB to access EKS pods
# This is added to the EKS-managed cluster security group that is automatically created
resource "aws_security_group_rule" "alb_to_pods" {
  ...
  description              = "Allow HTTP traffic from ALB to EKS pods"
}
...
resource "aws_ecr_repository" "flask_app" {
  ...
  force_delete         = true  # Automatically delete images on destroy
